...
<body>
                    ...
                    <div class="single">
                        ...
                        <div class="itinary">
                            ...
                            <ul class="d-flex align-items-left justify-content-between text-center m-auto">
                                ...
                                <li>
                                    <div>
                                        <img src="<?php echo $package["packageInclusion"]["img2"] ?>" alt="">
                                    </div>
                                    <p>Hotels</p>
                                </li>
                                <li>
                                    <div>
                                        <img src="<?php echo $package["packageInclusion"]["img3"] ?>" alt="">
                                    </div>
                                    <p>Meals</p>
                                </li>
                                <li>
                                    <div>
                                        <img src="<?php echo $package["packageInclusion"]["img4"] ?>" alt="">
                                    </div>
                                    <p>Sightseeing</p>
                                </li>
                            </ul>
                        ...
                        <div class="read pt-3">
                            ...
                            <div class="d-flex pb-3">
                                ...
                                <div style="width:100%">
                                    ...
                                    <button class="d-flex" style="cursor: pointer;background: transparent;border: 0px;float: right;color: #e10000;font-weight: 700;">
                                        <div style="width: 20px;">
                            ...
                            <div class="border-top w-100 d-flex justify-content-between align-items-center border-bottom pb-2">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div>
                                        <img src="https://spiti-trip.com/images/icon/icon-whatsapp.webp" alt="">
                                    </div>
                                    <div>
    ...
    <div class="p-5" >
    <div class="row p-5 m-auto " id="grid-temp">
        <div class="col">
            <div class="mb-5">
